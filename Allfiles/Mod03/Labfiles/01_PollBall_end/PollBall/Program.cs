...
PollResultsService pollResults = null!;

using(var scope = app.Services.CreateScope())
{
    pollResults = (PollResultsService) scope.ServiceProvider.GetRequiredService<IPollResultsService>();
...
// {
//     await context.Response.WriteAsync("This text was generated by the app.Run middleware. wwwroot folder path: " + app.Environment.WebRootPath);
// });
